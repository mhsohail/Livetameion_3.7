    ...
    public class ProductsController : BasePluginController
    {
        ...
        public ActionResult ProductSpecAttrList(DataSourceRequest command, int productId)
        {
            ...
            var productrSpecsModel = productrSpecs
                .Select(x =>
                {
                    var psaModel = new Admin.Models.Catalog.ProductSpecificationAttributeModel
                    {
                        Id = x.Id,
        ...
        protected virtual void PrepareProductSpecsModel(IList<ProductSpecificationAttribute> productSpecs, List<ViewModels.ProductSpecificationAttributeModel> modelList)
        {
            if (modelList == null)
                throw new ArgumentNullException("model");
        ...
        [HttpPost]
        public ActionResult ProductSpecAttrUpdate(Admin.Models.Catalog.ProductSpecificationAttributeModel model)
        {
            //if (!_permissionService.Authorize(StandardPermissionProvider.ManageProducts))
            //    return AccessDeniedView();
