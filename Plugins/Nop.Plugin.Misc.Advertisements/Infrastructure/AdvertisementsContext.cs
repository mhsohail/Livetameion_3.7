...
{
    public class AdvertisementsContext : DbContext, IDbContext
    {
        public AdvertisementsContext(string nameOrConnectionString) : base(nameOrConnectionString) { }
        ...
        {
            var dbScript = "DROP TABLE Advertisements";
