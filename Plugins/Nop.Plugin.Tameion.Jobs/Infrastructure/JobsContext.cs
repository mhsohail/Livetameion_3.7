...
using Nop.Plugin.Tameion.Jobs.Helpers;
using System;
...
{
    public class JobsContext : DbContext, IDbContext
    {
        public JobsContext(string nameOrConnectionString) : base(nameOrConnectionString) { }
        ...
        public void Install()
        {
            Database.SetInitializer<JobsContext>(null);
        ...
        {
            var dbScript = "DROP TABLE " + PluginHelper.GetTableName<Job>(this);
