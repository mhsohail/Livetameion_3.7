...
using Nop.Plugin.Tameion.SelectAndSell.Extensions;
...
namespace Nop.Plugin.Tameion.SelectAndSell.Controllers
{
    public partial class SelectSellController : BasePluginController
    {
        ...
        public ActionResult Index()
        {
            ...
            vendor.SetReferenceProductId(1);
            var ids = vendor.GetReferenceProductIds();
        ...
        public ActionResult List()
        {
            ...
            var model = new Nop.Plugin.Tameion.SelectAndSell.ViewModels.ProductListModel();
